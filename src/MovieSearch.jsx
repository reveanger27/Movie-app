...
function MovieSearch () {
    ...
    return (
        <div className="min-h-screen bg-gray-100 py-10 px-6">
            ...
            <div className="flex flex-col sm:flex-row gap-2 justify-center mb-6 px-4">
                <input
                    type="text"
                    value={query}
                    ...
                    className="border border-gray-300 rounded-full px-4 py-2 w-full sm:w-80 focus:outline-none focus:ring-2 focus:ring-blue-400"
                />
                <div className="flex gap-2 justify-center">
                    <button onClick={searchMovies} className="bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-900 transition">
                        Cari
                    </button>
                    <button onClick={resetSearch} className="bg-gray-300 text-gray-700 px-6 py-2 rounded-full hover:bg-gray-400 transition">
                        Reset
                    </button>
                </div>
            </div>
